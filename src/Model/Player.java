...
public class Player {
    ...
    public Player(int x,int y){
        playerImg=new Image("ressources/spaceship.png");
    ...
    public ImageView getBombs(double to) {
        bombs=new Bombs(playerImgV.getX()+25,playerImgV.getY(),"ressources/rocket.png",1000);
    ...
    public ImageView rocketDist(){
        deathSmook=new ImageView("ressources/rocketFire.png");
